...
from pyehr.core.base.foundation_types.time import TimeDefinitions as td
from pyehr.core.base.foundation_types.time import ISODate, ISODuration, ISOTimeZone, ISOTime, ISODateTime
