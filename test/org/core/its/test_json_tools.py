...
from org.core.base.foundation_types.time import ISODate, ISOTime, ISODuration, ISODateTime
from org.core.base.foundation_types.interval import PointInterval, ProperInterval, MultiplicityInterval
from org.core.base.foundation_types.primitive_types import Uri
from org.core.base.foundation_types.terminology import TerminologyCode, TerminologyTerm
from org.core.base.base_types.identification import TerminologyID
from org.core.base.base_types.identification import TerminologyID, ISOOID, UUID, InternetID, VersionTreeID, HierObjectID, ObjectVersionID, ArchetypeID, TemplateID, GenericID, ObjectRef, PartyRef
from org.core.base.resource import TranslationDetails, ResourceDescriptionItem, ResourceDescription, AuthoredResource

from org.core.its.json_tools import OpenEHREncoder

from org.core.rm.data_types.text import DVText, DVUri, DVCodedText, CodePhrase, TermMapping, DVParagraph
from org.core.rm.data_types.basic import DVIdentifier, DVBoolean, DVState
from org.core.rm.data_types.uri import DVEHRUri
from org.core.rm.data_types.quantity import DVCount, DVQuantity, DVInterval, DVOrdinal, DVProportion, ProportionKind, DVScale, ReferenceRange
from org.core.rm.data_types.quantity.date_time import DVDate, DVTime, DVDuration, DVDateTime
from org.core.rm.data_types.encapsulated import DVParsable, DVMultimedia
from org.core.rm.data_types.time_specification import DVGeneralTimeSpecification, DVPeriodicTimeSpecification

from org.core.rm.support.terminology import OpenEHRTerminologyGroupIdentifiers

from org.core.rm.common.archetyped import FeederAudit, FeederAuditDetails, Link, Archetyped
from org.core.rm.common.generic import Attestation, PartyIdentified, PartyRelated, PartySelf, PartyRef, RevisionHistoryItem, RevisionHistory, AuditDetails, Participation
from org.core.rm.common.change_control import OriginalVersion, ImportedVersion, VersionedObject, Contribution
from org.core.rm.common.directory import Folder

from org.core.rm.data_structures.representation import Cluster, Element
from org.core.rm.data_structures.item_structure import ItemSingle, ItemList
...
def validate(json_obj):
    _schema = json.loads(open("test/org/core/its/schemas/openehr_rm_1.1.0_alltypes_strict.json").read())
